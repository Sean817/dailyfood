  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-40">
      <div className="container mx-auto px-2 sm:px-4">
        {/* 移动端：垂直布局 */}
        <div className="flex flex-col sm:hidden py-2 space-y-2">
          {/* 第一行：标题和统计 */}
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors border border-gray-200"
            >
